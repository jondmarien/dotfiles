...
-- Set default domain if you want to start in WSL
...
--    	},
	...
	{	
    		key = 'x',  -- or any other key you prefer
    		mods = 'CTRL|SHIFT|ALT',
...
config.window_frame = {
    font = wezterm.font({
        family = 'CaskaydiaMono Nerd Font',  -- Use the same name that worked above
        weight = 'Regular'
    }),
...
-- config.window_background_image = "C:/Users/nucle/Desktop/wallpaper.png"
